...
const AdminHelpGuide = ({ onClose }: { onClose: () => void }) => {
  return (
    <div className="fixed inset-0 bg-black/70 z-[100] flex items-center justify-center p-4" onClick={onClose}>
      <Card
        className="w-full max-w-3xl bg-white relative h-[90vh] flex flex-col"
      ...
      >
        ...
        <CardContent className="flex-1 overflow-y-auto space-y-6 pr-3">
          <div className="space-y-4 text-sm text-navy/80">
            <div className="space-y-1">
              <h3 className="font-display text-lg uppercase tracking-wide text-navy">Admin Menu & Navigation</h3>
              <p>
            ...
            <div className="space-y-1">
              <h3 className="font-display text-lg uppercase tracking-wide text-navy">Metrics</h3>
              <p>
            ...
            <div className="space-y-1">
              <h3 className="font-display text-lg uppercase tracking-wide text-navy">Products</h3>
              <p>
            ...
            <div className="space-y-1">
              <h3 className="font-display text-lg uppercase tracking-wide text-navy">Orders</h3>
              <p>
            ...
            <div className="space-y-1">
              <h3 className="font-display text-lg uppercase tracking-wide text-navy">Users</h3>
              <p>
...
const AdminDashboard = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <Card className="border-navy/15 shadow-card bg-white/95 mb-6">
            ...
            <CardContent className="flex flex-wrap gap-2">
              ...
              <Button variant="outline" className="border-sky-300 bg-sky-50 text-sky-900 hover:bg-sky-100" onClick={() => setIsHelpOpen(true)}>
      ...
      {isHelpOpen && <AdminHelpGuide onClose={() => setIsHelpOpen(false)} />}
